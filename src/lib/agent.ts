...
const modeInstructions: Record<AgentMode, string> = {
  ...
  socratic:
    [
      "苏格拉底模式：你的任务不是替学习者回答，而是逼学习者自己回答。",
      "先判断这个问题背后的关键分歧点，然后只提出 1 到 3 个连续的小问题。",
      "不要直接给标准答案，不要写成长解释，不要一次把结论说完。",
      "每个问题都要短，能推动下一步判断，一次只推进一个小问题。",
      "如果学习者的问题过大，先缩小范围；如果概念混淆，先要求他区分概念。",
      "只有在学习者明确要求揭晓，或者已经完成一轮回答后，才可以给参考答案。",
    ].join(" "),
  quiz:
